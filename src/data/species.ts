...
// Covers all three ecosystems with trophic levels 1 (producer) -> 4 (apex).
export const SPECIES: Species[] = [
  ...
  { id: "t-tanuki", nameJa: "ホンドタヌキ", nameSci: "Nyctereutes viverrinus", ecosystem: "terrestrial", category: "哺乳類", trophicLevel: 3, rarity: "uncommon", invasive: false, emoji: "🦝" },
  ...
  { id: "t-mantis", nameJa: "カマキリ", nameSci: "Tenodera sinensis", ecosystem: "terrestrial", category: "昆虫", trophicLevel: 3, rarity: "common", invasive: false, emoji: "🦗" },
  ...
  { id: "t-snail", nameJa: "カタツムリ", nameSci: "Euhadra peliomphala", ecosystem: "terrestrial", category: "節足動物以外", trophicLevel: 2, rarity: "common", invasive: false, emoji: "🐌" },
  ...
  { id: "f-bass", nameJa: "オオクチバス", nameSci: "Micropterus salmoides", ecosystem: "freshwater", category: "魚類", trophicLevel: 3, rarity: "uncommon", invasive: true, emoji: "🐠" },
  ...
  { id: "m-tuna", nameJa: "クロマグロ", nameSci: "Thunnus orientalis", ecosystem: "marine", category: "大型魚類", trophicLevel: 4, rarity: "rare", invasive: false, emoji: "🐟" },
